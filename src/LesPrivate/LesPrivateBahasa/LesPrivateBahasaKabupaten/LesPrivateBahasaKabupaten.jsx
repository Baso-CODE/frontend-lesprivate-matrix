...
"
        ...
        <link
          rel="canonical"
          href={`https://apps.bimbelmatrix.com/les-privat-bahasa-asing/${kotaSlug}/${kabupatenSlug}`}
        />
      ...
      `}
        ...
        <meta
          property="og:url"
          content={`https://apps.bimbelmatrix.com/les-privat-bahasa-asing/${kotaSlug}/${kabupatenSlug}`}
        />
