  ...
  return (
    <React.Fragment>
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          {`Bimbel dan Les Privat Mahasiswa di ${nameCountry} Terbaik #1 Les Private Matrix`}
        </title>
        <meta name="robots" content="index, follow" />
        <meta
          name="description"
          content={`Les privat terbaik untuk mahasiswa dengan berbagai pilihan program fleksibel, termasuk les privat online dan offline terbaik di ${nameCountry}. Temukan dukungan belajar terbaik dengan Les Private Matrix. `}
        />
        <meta
          name="keywords"
          content="
...
"
        ...
        <link
          rel="canonical"
          href={`https://apps.bimbelmatrix.com/les-privat-mahasiswa/${kotaSlug}/${kabupatenSlug}/${kecamatanSlug}/${kelurahanSlug}`}
        />

        {/* Open Graph Meta Tags */}
        <meta
          property="og:title"
          content={`Les Privat Mahasiswa di ${nameCountry} Terbaik #1 Les Private Matrix`}
        />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://apps.bimbelmatrix.com/les-privat-mahasiswa/${kotaSlug}/${kabupatenSlug}/${kecamatanSlug}/${kelurahanSlug}`}
        />
