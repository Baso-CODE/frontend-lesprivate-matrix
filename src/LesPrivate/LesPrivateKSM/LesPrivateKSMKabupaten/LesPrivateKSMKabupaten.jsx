  ...
  return (
    <React.Fragment>
      ...
      dan Berhitung - untuk SD, SMP, SMA Les Privat Matrix `}
        ...
        <link
          rel="canonical"
          href={`https://apps.bimbelmatrix.com/les-privat-akm-asesmen-kompetensi-minimum/${kotaSlug}/${kabupatenSlug}`}
        />
      ...
      dan Berhitung untuk SD, SMP, SMA Les Privat Matrix `}
        ...
        <meta
          property="og:url"
          content={`https://apps.bimbelmatrix.com/les-privat-akm-asesmen-kompetensi-minimum/${kotaSlug}/${kabupatenSlug}`}
        />
...
export default LesPrivateKSMKabupaten;
