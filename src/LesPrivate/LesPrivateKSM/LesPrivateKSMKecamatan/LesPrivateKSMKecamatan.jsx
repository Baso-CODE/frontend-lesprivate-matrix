...
const LesPrivateKSMKecamatan = () => {
  ...
  dan Berhitung untuk SD, SMP, SMA Les Privat Matrix `}
        ...
        <link
          rel="canonical"
          href={`https://apps.bimbelmatrix.com/les-privat-akm-asesmen-kompetensi-minimum/${kotaSlug}/${kabupatenSlug}/${kecamatanSlug}`}
        />
  ...
  dan Berhitung untuk SD, SMP, SMA Les Privat Matrix `}
        ...
        <meta
          property="og:url"
          content={`https://apps.bimbelmatrix.com/les-privat-akm-asesmen-kompetensi-minimum/${kotaSlug}/${kabupatenSlug}/${kecamatanSlug}`}
        />
...
export default LesPrivateKSMKecamatan;
