  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`https://apps.bimbelmatrix.com/les-privat-akm-asesmen-kompetensi-minimum/${kotaSlug}`}
        />
        ...
        <meta
          property="og:url"
          content={`https://apps.bimbelmatrix.com/les-privat-akm-asesmen-kompetensi-minimum/${kotaSlug}`}
        />
...
export default LesPrivateKSMKota;
