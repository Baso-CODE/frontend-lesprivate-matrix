  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const heroImage = await getHeroData("SD", "kabupaten");
  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`https://apps.bimbelmatrix.com/les-privat-sd/${kotaSlug}/${kabupatenSlug}`}
        />
        <meta
          property="og:title"
        ...
        <meta
          property="og:url"
          content={`https://apps.bimbelmatrix.com/les-privat-sd/${kotaSlug}/${kabupatenSlug}`}
        />
