  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const heroImage = await getHeroData("SD", "kota");
  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`https://apps.bimbelmatrix.com/les-privat-sd/${kotaSlug}`}
        />
        <meta
          property="og:title"
        ...
        <meta
          property="og:url"
          content={`https://apps.bimbelmatrix.com/les-privat-sd/${kotaSlug}`}
        />
