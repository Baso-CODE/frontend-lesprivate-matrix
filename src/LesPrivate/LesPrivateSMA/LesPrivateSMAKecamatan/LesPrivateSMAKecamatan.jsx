...
"
        ...
        <link
          rel="canonical"
          href={`https://apps.bimbelmatrix.com/les-privat-sma/${kotaSlug}/${kabupatenSlug}/${kecamatanSlug}`}
        />
        ...
        <meta
          property="og:url"
          content={`https://apps.bimbelmatrix.com/les-privat-sma/${kotaSlug}/${kabupatenSlug}/${kecamatanSlug}`}
        />
