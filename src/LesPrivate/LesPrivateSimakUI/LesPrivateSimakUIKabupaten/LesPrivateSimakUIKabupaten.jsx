  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const getHero = await getHeroData("SIMAK-UI", "kabupaten");
        setHeroData(getHero);
      } catch (error) {
...
"
        ...
        <link
          rel="canonical"
          href={`https://apps.bimbelmatrix.com/les-privat-simak-ui/${kotaSlug}/${kabupatenSlug}`}
        />
        ...
        <meta
          property="og:url"
          content={`https://apps.bimbelmatrix.com/les-privat-simak-ui/${kotaSlug}/${kabupatenSlug}`}
        />
