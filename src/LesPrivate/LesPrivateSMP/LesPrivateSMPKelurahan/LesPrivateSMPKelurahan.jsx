...
const LesPrivateSMPKelurahan = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const getHero = await getHeroData("SMP", "kelurahan");
        setHeroData(getHero);
      } catch (error) {
  ...
  return (
    ...
    "
        ...
        <link
          rel="canonical"
          href={`https://apps.bimbelmatrix.com/les-privat-smp/${kotaSlug}/${kabupatenSlug}/${kecamatanSlug}/${kelurahanSlug}`}
        />
        ...
        <meta
          property="og:url"
          content={`https://apps.bimbelmatrix.com/les-privat-smp/${kotaSlug}/${kabupatenSlug}/${kecamatanSlug}/${kelurahanSlug}`}
        />
