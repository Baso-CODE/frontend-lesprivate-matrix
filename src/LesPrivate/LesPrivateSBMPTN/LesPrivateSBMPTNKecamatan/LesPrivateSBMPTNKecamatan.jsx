...
"
        ...
        <link
          rel="canonical"
          href={`https://apps.bimbelmatrix.com/les-privat-sbmptn/${kotaSlug}/${kabupatenSlug}/${kecamatanSlug}`}
        />
        ...
        <meta
          property="og:url"
          content={`https://apps.bimbelmatrix.com/les-privat-sbmptn/${kotaSlug}/${kabupatenSlug}/${kecamatanSlug}`}
        />
