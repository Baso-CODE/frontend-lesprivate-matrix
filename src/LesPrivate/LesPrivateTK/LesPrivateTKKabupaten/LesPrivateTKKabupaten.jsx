  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const heroImage = await getHeroData("TK", "kabupaten");
    ...
    <div>
      <React.Fragment>
        <Helmet>
          <meta charSet="utf-8" />
          <title>
            Les Privat TK Terbaik {`${kabupaten.kota_kabupaten}`} #1 Guru Les
            Privat Calistung PAUD dan Taman Kanak-Kanak Matrix Tutoring
          </title>
          <meta name="robots" content="index, follow" />
          <meta
            name="description"
            content={`Les Privat TK Terbaik di ${kabupaten.kota_kabupaten}, meliputi calistung, PAUD, dan kegiatan belajar untuk masa taman kanak-kanak. Guru les privat berpengalaman hadir secara online dan offline.`}
          />
          <meta
            name="keywords"
          ...
          <link
            rel="canonical"
            href={`https://apps.bimbelmatrix.com/les-privat-tk/${kotaSlug}/${kabupatenSlug}`}
          />
          <meta
            property="og:title"
            content={`Les Privat TK Terbaik #1 di ${kabupaten.kota_kabupaten} Guru Les Privat Calistung dan PAUD`}
          />
          <meta
            property="og:description"
            content={`Les Privat TK dan PAUD terbaik di ${kabupaten.kota_kabupaten}. Program belajar dari guru privat berpengalaman yang mencakup calistung, taman kanak-kanak, dan PAUD, tersedia secara online dan offline.`}
          />
          <meta
            property="og:url"
            content={`https://apps.bimbelmatrix.com/les-privat-tk/${kotaSlug}/${kabupatenSlug}`}
          />
          ...
          <meta
            ...
            content={`Les Privat TK terbaik di ${kabupaten.kota_kabupaten}, termasuk calistung, PAUD, dan program belajar taman kanak-kanak. Guru privat online dan offline berpengalaman.`}
          />
          <meta
            name="twitter:image"
            content="https://apps.bimbelmatrix.com/images/DSIKON_BULANAN.webp"
